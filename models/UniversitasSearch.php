...
class UniversitasSearch extends Universitas
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['nama_kampus', 'alamat_kampus', 'agreditas_kampus'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nama_kampus', $this->nama_kampus])
            ->andFilterWhere(['like', 'alamat_kampus', $this->alamat_kampus])
            ->andFilterWhere(['like', 'agreditas_kampus', $this->agreditas_kampus]);
